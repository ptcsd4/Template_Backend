(function ($) {
    ...
    $.fn.PTCDynamicTabs = function (option) {
        ...
        function newTab() {
            ...
            //       "<a class='ptc-tab-ch c" + index + "'" + ' data-toggle="tab" ' + " href='#c" + index + "'>查詢條件</a></li>"


            return `<li class="${className} ptc-li"><a class="ptc-tab-ch c${index}" data-toggle="tab"  href="#c${index}">查詢條件</a></li>`;
        }
        ...
        function addNewContent(content) {
            ...
            $('.ptc-cancel').click(function () {
                ...
                if ($('.ptc-li > a').length <= 1) {

                    window.PTC && window.PTC.alertPop.basic({message : "查詢條件為必要項目"})
                    return;
                }
                ...
                $target.find('.ptc-li > a').last().click();
